...
use Modules\IAM\Http\Controllers\Api\AuthController;
use Modules\IAM\Http\Controllers\Api\PermissionController;
use Modules\IAM\Http\Controllers\Api\RoleController;
    ...
    ->group(function (): void {
        Route::prefix('auth')
            ...
            ->group(function (): void {
                ...
                Route::middleware('iam.auth')->group(function (): void {
