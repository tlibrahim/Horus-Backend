...
use Modules\IAM\Http\Requests\Auth\ChangePasswordRequest;
use Modules\IAM\Http\Requests\Auth\ForgotPasswordRequest;
use Modules\IAM\Http\Requests\Auth\LoginRequest;
use Modules\IAM\Http\Requests\Auth\LogoutRequest;
use Modules\IAM\Http\Requests\Auth\RefreshRequest;
use Modules\IAM\Http\Requests\Auth\RegisterRequest;
use Modules\IAM\Http\Requests\Auth\ResendOtpRequest;
use Modules\IAM\Http\Requests\Auth\ResetPasswordRequest;
use Modules\IAM\Http\Requests\Auth\VerifyOtpRequest;
...
final class AuthController extends BaseApiController
{
    ...
    public function logout(LogoutRequest $request): JsonResponse
    {
        ...
        if ($user !== null) {
            ...
            $token = $request->attributes->get('iam_refresh_token');
