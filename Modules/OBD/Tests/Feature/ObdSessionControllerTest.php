...
final class ObdSessionControllerTest extends TestCase
{
    public function test_it_can_list_obd_sessions(): void
    {
        $response = $this->getJson(
            route('api.v1.obd.sessions.index'),
            $this->apiHeaders(),
        );
    ...
    {
        $response = $this->getJson(
            route('api.v1.obd.sessions.options'),
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_show_obd_session(): void
    {
        ...
        $response = $this->getJson(
            route('api.v1.obd.sessions.show', $session),
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_store_obd_session(): void
    {
        ...
        $response = $this->postJson(
            route('api.v1.obd.sessions.store'),
    ...
    public function test_it_can_update_obd_session(): void
    {
        ...
        $response = $this->putJson(
            route('api.v1.obd.sessions.update', $session),
            [
                'status' => 'connected',
            ],
            $this->apiHeaders(),
    ...
    public function test_it_can_delete_obd_session(): void
    {
        ...
        $response = $this->deleteJson(
            route('api.v1.obd.sessions.destroy', $session),
            [],
            $this->apiHeaders(),
        );
