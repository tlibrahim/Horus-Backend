...
final class PermissionControllerTest extends TestCase
{
    public function test_it_can_list_permissions(): void
    {
        $response = $this->getJson(
            route('api.v1.auth.permissions.index'),
            $this->apiHeaders(),
        );
    ...
    {
        $response = $this->getJson(
            route('api.v1.auth.permissions.options'),
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_show_a_permission(): void
    {
        ...
        $response = $this->getJson(
            route('api.v1.auth.permissions.show', $permission),
            $this->apiHeaders(),
        );
    ...
    {
        $response = $this->getJson(
            route('api.v1.auth.permissions.show', 999999),
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_store_permission(): void
    {
        $response = $this->postJson(
            route('api.v1.auth.permissions.store'),
    ...
    public function test_it_can_update_permission(): void
    {
        ...
        $response = $this->putJson(
            route('api.v1.auth.permissions.update', $permission),
            $this->validPermissionData([
                'name' => 'roles.audit',
                'code' => 'roles.audit',
                'group' => 'auth',
    ...
    public function test_it_can_delete_permission(): void
    {
        ...
        $response = $this->deleteJson(
            route('api.v1.auth.permissions.destroy', $permission),
            [],
            $this->apiHeaders(),
        );
    ...
    {
        $response = $this->deleteJson(
            route('api.v1.auth.permissions.destroy', 999999),
            [],
            $this->apiHeaders(),
        );
