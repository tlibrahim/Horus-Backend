...
final class RoleControllerTest extends TestCase
{
    ...
    {
        $response = $this->getJson(
            route('api.v1.auth.roles.options'),
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_show_a_role(): void
    {
        ...
        $response = $this->getJson(
            route('api.v1.auth.roles.show', $role),
            $this->apiHeaders(),
        );
    ...
    {
        $response = $this->getJson(
            route('api.v1.auth.roles.show', 999999),
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_update_role(): void
    {
        ...
        $response = $this->putJson(
            route('api.v1.auth.roles.update', $role),
            $this->validRoleData([
    ...
    public function test_it_can_toggle_role_status(): void
    {
        ...
        $response = $this->patchJson(
            route('api.v1.auth.roles.toggleStatus', $role),
            [
    ...
    public function test_it_can_activate_role(): void
    {
        ...
        $response = $this->patchJson(
            route('api.v1.auth.roles.activate', $role),
            [],
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_deactivate_role(): void
    {
        ...
        $response = $this->patchJson(
            route('api.v1.auth.roles.deactivate', $role),
            [],
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_get_role_permissions(): void
    {
        ...
        $response = $this->getJson(
            route('api.v1.auth.roles.permissions', $role),
            $this->apiHeaders(),
        );
    ...
    public function test_it_can_sync_role_permissions(): void
    {
        ...
        $response = $this->putJson(
            route('api.v1.auth.roles.syncPermissions', $role),
            [
    ...
    public function test_it_can_delete_role(): void
    {
        ...
        $response = $this->deleteJson(
            route('api.v1.auth.roles.destroy', $role),
            [],
            $this->apiHeaders(),
        );
    ...
    {
        $response = $this->deleteJson(
            route('api.v1.auth.roles.destroy', 999999),
            [],
            $this->apiHeaders(),
        );
